(function (global, factory) {
  ...
  (global = global || self, factory(global.vuejsDatepicker = {}, global.dateFns));
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-3df43aee_0", { source: ".vdp__arrow-container[data-v-3df43aee] {\n  position: relative;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.vdp__arrow-container[data-v-3df43aee]:hover {\n  cursor: pointer;\n}\n.vdp__arrow-container.disabled .arrow[data-v-3df43aee]::before {\n  border-color: #ddd;\n}\n.vdp__arrow-container.disabled .arrow[data-v-3df43aee]::after {\n  background-color: #ddd;\n}\n.vdp__arrow-container .arrow[data-v-3df43aee] {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: relative;\n}\n.vdp__arrow-container .arrow[data-v-3df43aee]::before {\n  content: \"\";\n  display: block;\n  width: 14px;\n  height: 14px;\n  border-style: solid;\n  border-color: #0070ff;\n  border-width: 2px 2px 0 0;\n  position: absolute;\n  transform-origin: 50% 50%;\n}\n.vdp__arrow-container .arrow[data-v-3df43aee]::after {\n  content: \"\";\n  display: block;\n  top: 50%;\n  left: 50%;\n  background-color: #0070ff;\n  position: absolute;\n  transform-origin: 50% 50%;\n}\n.vdp__arrow-container .arrow.right[data-v-3df43aee]::before {\n  transform: rotate(225deg);\n}\n.vdp__arrow-container .arrow.right[data-v-3df43aee]::after {\n  width: 20px;\n  height: 2px;\n  transform: translate(-9px, -1px);\n}\n.vdp__arrow-container .arrow.left[data-v-3df43aee]::before {\n  transform: rotate(45deg);\n}\n.vdp__arrow-container .arrow.left[data-v-3df43aee]::after {\n  width: 20px;\n  height: 2px;\n  transform: translate(-10px, -1px);\n}\n\n/*# sourceMappingURL=Arrow.vue.map */", map: {"version":3,"sources":["/Users/rei/projects/vuejs-datepicker/src/components/Arrow.vue","Arrow.vue"],"names":[],"mappings":"AAiBA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;AChBA;ADiBA;EACA,eAAA;ACfA;ADkBA;EACA,kBAAA;AChBA;ADkBA;EACA,sBAAA;AChBA;ADmBA;EACA,WAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;ACjBA;ADkBA;EACA,WAAA;EACA,cAAA;EACA,WAAA;EACA,YAAA;EACA,mBAAA;EACA,qBAAA;EACA,yBAAA;EACA,kBAAA;EACA,yBAAA;AChBA;ADkBA;EACA,WAAA;EACA,cAAA;EACA,QAAA;EACA,SAAA;EACA,yBAAA;EACA,kBAAA;EACA,yBAAA;AChBA;ADkBA;EACA,yBAAA;AChBA;ADkBA;EACA,WAAA;EACA,WAAA;EACA,gCAAA;AChBA;ADkBA;EACA,wBAAA;AChBA;ADkBA;EACA,WAAA;EACA,WAAA;EACA,iCAAA;AChBA;;AAEA,oCAAoC","file":"Arrow.vue","sourcesContent":["<template>\n  <div class=\"vdp__arrow-container\" @click=\"$emit('click')\">\n    <div class=\"arrow\" :class=\"{'right': right, 'left': left }\" />\n  </div>\n</template>\n\n<script>\nexport default {\n  props: {\n    right: Boolean,\n    left: Boolean\n  }\n}\n</script>\n\n\n<style lang=\"scss\" scoped>\n.vdp__arrow-container {\n  position: relative;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  &:hover {\n    cursor: pointer;\n  }\n  &.disabled {\n    .arrow::before {\n      border-color: #ddd;\n    }\n    .arrow::after {\n      background-color: #ddd;\n    }\n  }\n  .arrow {\n    width: 100%;\n    height: 100%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    position: relative;\n    &::before {\n      content: '';\n      display: block;\n      width: 14px;\n      height: 14px;\n      border-style: solid;\n      border-color: #0070ff;\n      border-width: 2px 2px 0 0;\n      position: absolute;\n      transform-origin: 50% 50%;\n    }\n    &::after {\n      content: '';\n      display: block;\n      top: 50%;\n      left: 50%;\n      background-color: #0070ff;\n      position: absolute;\n      transform-origin: 50% 50%;\n    }\n    &.right::before {\n      transform: rotate(225deg);\n    }\n    &.right::after { \n      width: 20px;\n      height: 2px;\n      transform: translate(-9px, -1px);\n    }\n    &.left::before {\n      transform: rotate(45deg);\n    }\n    &.left::after { \n      width: 20px;\n      height: 2px;\n      transform: translate(-10px, -1px);\n    }\n  }\n}\n\n</style>\n",".vdp__arrow-container {\n  position: relative;\n  width: 40px;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.vdp__arrow-container:hover {\n  cursor: pointer;\n}\n.vdp__arrow-container.disabled .arrow::before {\n  border-color: #ddd;\n}\n.vdp__arrow-container.disabled .arrow::after {\n  background-color: #ddd;\n}\n.vdp__arrow-container .arrow {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: relative;\n}\n.vdp__arrow-container .arrow::before {\n  content: \"\";\n  display: block;\n  width: 14px;\n  height: 14px;\n  border-style: solid;\n  border-color: #0070ff;\n  border-width: 2px 2px 0 0;\n  position: absolute;\n  transform-origin: 50% 50%;\n}\n.vdp__arrow-container .arrow::after {\n  content: \"\";\n  display: block;\n  top: 50%;\n  left: 50%;\n  background-color: #0070ff;\n  position: absolute;\n  transform-origin: 50% 50%;\n}\n.vdp__arrow-container .arrow.right::before {\n  transform: rotate(225deg);\n}\n.vdp__arrow-container .arrow.right::after {\n  width: 20px;\n  height: 2px;\n  transform: translate(-9px, -1px);\n}\n.vdp__arrow-container .arrow.left::before {\n  transform: rotate(45deg);\n}\n.vdp__arrow-container .arrow.left::after {\n  width: 20px;\n  height: 2px;\n  transform: translate(-10px, -1px);\n}\n\n/*# sourceMappingURL=Arrow.vue.map */"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$1 = "data-v-3df43aee";
    /* module identifier */
  ...
  var getHrs = function getHrs(date, isPm) {
    if (!date) return 0;
    var h = isPm ? 'H' : 'h';
    return Number(dateFns.lightFormat(new Date(date), h));
  };
  ...
  var script$6 = {
    ...
    mounted: function mounted() {
      ...
      this.selMin = dateFns.getMinutes(this.selectedVal);
    ...
    computed: {
      currentDate: function currentDate() {
        return {
          year: dateFns.getYear(this.selectedVal),
          month: dateFns.getMonth(this.selectedVal),
          date: dateFns.getDate(this.selectedVal),
          hour: dateFns.getHours(this.selectedVal),
          minute: dateFns.getMinutes(this.selectedVal)
        };
      },
      formattedVal: function formattedVal() {
        if (!this.selectedTime || !dateFns.isValid(this.selectedTime)) return '';
        return dateFns.lightFormat(this.selectedTime, 'hh:mm') || '';
      },
      ...
      hours: function hours() {
        ...
        return _toConsumableArray(Array(this.hoursLen).keys()).map(function (v) {
          return {
            value: v,
            id: v,
            name: addZero(swapTwelve(isPm(_this2.meridiem))(v))
          };
        });
      },
  ...
  __vue_render__$7._withStripped = true;
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-1f2e19eb_0", { source: ".tp__meridiem-btn {\n  background-color: #f6f6f6;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  cursor: pointer;\n}\n.tp__meridiem-btn.selected, .tp__meridiem-btn:hover {\n  background-color: #0070ff;\n  color: #fff;\n}\n\n/*# sourceMappingURL=MeridiemBtn.vue.map */", map: {"version":3,"sources":["/Users/rei/projects/vuejs-datepicker/src/components/TimePicker/MeridiemBtn.vue","MeridiemBtn.vue"],"names":[],"mappings":"AAmCA;EACA,yBAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,eAAA;EACA,eAAA;AClCA;ADmCA;EACA,yBAAA;EACA,WAAA;ACjCA;;AAEA,0CAA0C","file":"MeridiemBtn.vue","sourcesContent":["<template>\n  <div :class=\"classes\" @click.self=\"onClick(meridiem)\">\n    {{ meridiem }}\n  </div>\n</template>\n\n<script>\nconst AM = 'AM'\nconst PM = 'PM'\n\nexport default {\n  props: {\n    am: Boolean,\n    selected: Boolean\n  },\n  computed: {\n    classes() {\n      return {\n        'tp__meridiem-btn': true,\n        'selected': this.selected\n      }\n    },\n    meridiem() {\n      return this.am ? AM : PM\n    }\n  },\n  methods: {\n    onClick(m) {\n      this.$emit('click', m)\n    }\n  }\n}\n</script>\n\n<style lang=\"scss\">\n.tp__meridiem-btn {\n  background-color: #f6f6f6;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  cursor: pointer;\n  &.selected, &:hover {\n    background-color: #0070ff;\n    color: #fff;\n  }\n}\n</style>\n",".tp__meridiem-btn {\n  background-color: #f6f6f6;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  cursor: pointer;\n}\n.tp__meridiem-btn.selected, .tp__meridiem-btn:hover {\n  background-color: #0070ff;\n  color: #fff;\n}\n\n/*# sourceMappingURL=MeridiemBtn.vue.map */"]}, media: undefined });
  ...
  var constructDefDate = function constructDefDate() {
    return dateFns.setMinutes(dateFns.setHours(new Date(), 0), 0);
  };
  ...
  var script$8 = {
    ...
    computed: {
      unix: function unix() {
        return dateFns.getTime(this.selectedVal) || dateFns.getTime(constructDefDate());
      },
      ...
      fmtVal: function fmtVal() {
        ...
        return dateFns.format(this.selectedVal, "".concat(h, ":mm"));
      },
      amPm: function amPm() {
    ...
    methods: {
      ...
      init: function init() {
        if (this.value && dateFns.isDate(this.value)) {
          this.setValue(this.value);
        }
      },
      setMeridiem: function setMeridiem(date) {
        var h = dateFns.getHours(date);
        this.currMeridiem = h >= 12 ? PM$1 : AM$1;
      },
      setValue: function setValue(date) {
        if (typeof date === 'number' || typeof date === 'string') {
          var d = new Date(date);
          date = dateFns.isValid(d) ? d : null;
        }
