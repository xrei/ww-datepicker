(function (global, factory) {
  ...
  __vue_render__$7._withStripped = true;
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-89475c46_0", { source: ".tp__meridiem-btn {\n  background-color: #f6f6f6;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  cursor: pointer;\n}\n.tp__meridiem-btn.selected {\n  background-color: #0070ff;\n  color: #fff;\n}\n\n/*# sourceMappingURL=MeridiemBtn.vue.map */", map: {"version":3,"sources":["/Users/rei/web/ww-vue-datepicker/src/components/TimePicker/MeridiemBtn.vue","MeridiemBtn.vue"],"names":[],"mappings":"AAmCA;EACA,yBAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,eAAA;EACA,eAAA;AClCA;ADmCA;EACA,yBAAA;EACA,WAAA;ACjCA;;AAEA,0CAA0C","file":"MeridiemBtn.vue","sourcesContent":["<template>\n  <div :class=\"classes\" @click.self=\"onClick(meridiem)\">\n    {{ meridiem }}\n  </div>\n</template>\n\n<script>\nconst AM = 'AM'\nconst PM = 'PM'\n\nexport default {\n  props: {\n    am: Boolean,\n    selected: Boolean\n  },\n  computed: {\n    classes() {\n      return {\n        'tp__meridiem-btn': true,\n        'selected': this.selected\n      }\n    },\n    meridiem() {\n      return this.am ? AM : PM\n    }\n  },\n  methods: {\n    onClick(m) {\n      this.$emit('click', m)\n    }\n  }\n}\n</script>\n\n<style lang=\"scss\">\n.tp__meridiem-btn {\n  background-color: #f6f6f6;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  cursor: pointer;\n  &.selected {\n    background-color: #0070ff;\n    color: #fff;\n  }\n}\n</style>\n",".tp__meridiem-btn {\n  background-color: #f6f6f6;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 12px;\n  cursor: pointer;\n}\n.tp__meridiem-btn.selected {\n  background-color: #0070ff;\n  color: #fff;\n}\n\n/*# sourceMappingURL=MeridiemBtn.vue.map */"]}, media: undefined });
