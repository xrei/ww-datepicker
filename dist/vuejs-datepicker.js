(function (global, factory) {
  ...
  var script$6 = {
    ...
    watch: {
      ...
      selectedVal: function selectedVal(v) {
        this.selHour = getHrs(v, this.isMilitary);
        this.selMin = dateFns.getMinutes(v);
        this.selectedTime = this.makeDate();
      }
    },
    methods: {
  ...
  var constructDefDate = function constructDefDate() {
    return dateFns.setMinutes(new Date(), 0);
  };
  ...
  var script$8 = {
    ...
    computed: {
      unix: function unix() {
        ...
        if (this.value) return dateFns.getTime(this.value);else if (this.selectedVal) return dateFns.getTime(this.selectedVal);else return dateFns.getTime(constructDefDate());
      },
